...
define('SECURITY_CLIENT_ID', '');  // QMWISe account
define('SECURITY_CHECKSUM', '');   // QMWISe checksum
...
define('DB_NAME', '');             // e.g. 'sqlite:qmp-lti.sqlitedb' or 'mysql:dbname=qmp-lti;host=localhost'
